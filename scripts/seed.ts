...
const SEED_STUDIOS = [
  {
    ...
    name: 'Wit Studio',
    slug: 'wit-studio',
    description: 'An anime studio behind celebrated productions, seeded from MyAnimeList top popularity rankings.',
...
function buildProject(mal: MalAnime): SeedProject {
  ...
  return {
    ...
    tiers: [
      { title: 'Digital Supporter', description: 'Name in credits and a digital art booklet.', price: 15, limitedQuantity: null, reward: 'Digital art booklet + credits', displayOrder: 0 },
      { title: `Collector's Edition`, description: 'A signed art print from the animation studio.', price: collectorPrice, limitedQuantity: 500, reward: 'Signed art print', displayOrder: 1 },
      { title: 'Executive Producer', description: 'Your name in the end credits as an EP.', price: 1_000, limitedQuantity: 20, reward: 'Executive producer credit', displayOrder: 2 },
    ],
    ledgers: [
      { label: 'Animation production', amount: animationAmount, note: 'Key frames and in-betweening.', displayOrder: 0 },
      { label: 'Music and sound', amount: musicAmount, note: 'Original score and voice cast.', displayOrder: 1 },
      { label: 'Distribution', amount: distributionAmount, note: 'Festival and streaming release.', displayOrder: 2 },
    ],
    blocks: [
